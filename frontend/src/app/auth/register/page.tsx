...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      setError(axiosErr.response?.data?.message || 'Erro ao criar conta');
    }
  };

  return (
    <div className="min-h-dvh min-h-screen flex flex-col items-center justify-center px-6 py-10 bg-surface-DEFAULT">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">É rápido, leva menos de 1 minuto</p>
        </div>
